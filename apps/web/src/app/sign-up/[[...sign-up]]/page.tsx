    ...
    <main className="mx-auto flex min-h-screen max-w-[1500px] items-center px-4 py-4 sm:px-6 lg:px-8">
      <div className="grid w-full gap-4 xl:grid-cols-[0.95fr_1.05fr]">
        <section className="panel-strong hidden rounded-[32px] p-8 xl:block">
          <p className="mono text-[11px] uppercase tracking-[0.3em] text-violet-200/65">Create account</p>
          <h1 className="mt-4 text-5xl font-semibold text-white">Create and join boards.</h1>
          <p className="mt-4 max-w-xl text-base leading-7 text-violet-100/70">
            Use Google or GitHub. After you sign up, you can create a board for your own group or join an existing public board and help manage its tracked sources.
          </p>
